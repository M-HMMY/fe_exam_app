...
/**
 * 直前チェックシート。教本 68 節に埋め込まれている要点だけを抜き出して並べる。
  ...
  return (
    <div className="page">
      <header className="page-head">
        <h1>直前チェックシート</h1>
        <p className="lead">
          教本 68 節に埋め込まれている「まとめ」「試験のポイント」「よくある勘違い」だけを抜き出して並べたものです。本文を読み返す時間がないときの総復習と、試験直前の見返しに使ってください。項目をタップすると、その節の本文へ移動します。
        </p>
      </header>
