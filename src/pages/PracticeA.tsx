...
import { QUESTIONS_A, questionsOfCategory, questionsOfSection } from '../data/questions';
...
export function PracticeA(): JSX.Element {
  ...
  const pool = useMemo(() => {
    ...
    else if (category === 'all') base = QUESTIONS_A;
  ...
  const start = (questions: QuestionA[]) => {
      ...
      <div className="page">
        ...
        {section && (
          <div className="notice">
            ...
            <button type="button" className="link-btn" onClick={() => navigate('practice-a')}>
              分野を選び直す
            </button>
          </div>
        )}
